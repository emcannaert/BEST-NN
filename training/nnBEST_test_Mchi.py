    ...
    for decayType in decayTypes:
        ...
        for mass_type in mass_types:
            for year in years:
                    ...
                    sampleTypeArray=tools.loadSampleTypes(args, sampleTypes, ["test"], maxEvents,mass_type, year)
                    tools.plotAll(args, strings, dataDict["testTruth"], args.modelType, BESpredict,mass_type, year, sampleTypes,sampleTypeArray)
