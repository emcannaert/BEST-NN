...
then 
	...
	## TTbar
	grep ToTTJets all_BEST_files_2015.txt  >  BEST_Top_2015.txt
	grep TTJets_TuneCP5_13TeV all_BEST_files_2015.txt  >> BEST_Top_2015.txt
	grep TTTo all_BEST_files_2015.txt   >> BEST_Top_2015.txt
	grep TTbar all_BEST_files_2015.txt  >> BEST_Top_2015.txt
	echo "Filled TTbar files 2015."

	## QCD
	grep QCD all_BEST_files_2015.txt  > BEST_QCD_2015.txt
	...
	## TTbar
	grep ToTTJets all_BEST_files_2016.txt  >  BEST_Top_2016.txt
	grep TTJets_TuneCP5_13TeV all_BEST_files_2016.txt  >> BEST_Top_2016.txt
	grep TTTo all_BEST_files_2016.txt   >> BEST_Top_2016.txt
	grep TTbar all_BEST_files_2016.txt  >> BEST_Top_2016.txt
	echo "Filled TTbar files 2016."

	## QCD
	grep QCD all_BEST_files_2016.txt  > BEST_QCD_2016.txt
	...
	## TTbar
	grep ToTTJets all_BEST_files_2017.txt  >  BEST_Top_2017.txt
	grep TTJets_TuneCP5_13TeV all_BEST_files_2017.txt  >> BEST_Top_2017.txt
	grep TTTo all_BEST_files_2017.txt   >> BEST_Top_2017.txt
	grep TTbar all_BEST_files_2017.txt  >> BEST_Top_2017.txt
	echo "Filled TTbar files 2017."

	## QCD
	grep QCD all_BEST_files_2017.txt  > BEST_QCD_2017.txt
	...
	## TTbar
	grep ToTTJets all_BEST_files_2018.txt  >  BEST_Top_2018.txt
	grep TTJets_TuneCP5_13TeV all_BEST_files_2018.txt  >> BEST_Top_2018.txt
	grep TTTo all_BEST_files_2018.txt   >> BEST_Top_2018.txt
	grep TTbar all_BEST_files_2018.txt  >> BEST_Top_2018.txt
	echo "Filled TTbar files 2018."

	## QCD
	grep QCD all_BEST_files_2018.txt  > BEST_QCD_2018.txt
