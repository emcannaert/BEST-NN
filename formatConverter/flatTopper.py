...
def flattenFile(minEvents, h5Dir, outDir, sampleTypes, year, setType, bins, binSize, maxRange, flattenIndex, userBatchSize):
...
if __name__ == "__main__":
    ...
    for year in years:
        for setType in setTypes:
            ...
            minEvents = getMinEvents(args.h5Dir, sampleTypes, year, setType, bins, binSize, args.rangeHigh, args.flattenIndex)
            flattenFile(minEvents, args.h5Dir, args.outDir, sampleTypes, year, setType, bins, binSize, args.rangeHigh, args.flattenIndex, args.batchSize)
