...
def delete_columns(h5_file, dataset_name, columns_to_delete):
    with h5py.File(h5_file, 'a') as f:
        ...
        #add one number at the end of the data to record their type. 0 is QCD, 1 is TT, 2 is WJets, 3 is ST, 4 is signal_1000, 5 is signal_1500, 6 is signal_2000, 7 is signal_2500, 8 is signal_3000
        new_column = np.full((modified_data.shape[0], 1), 2, dtype=int)
...
# Usage
h5_file = 'WJets_Sample_2018_BESTinputs.h5'
