...
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL16MiniAODv2/SuuToChiChiToWBWBToJets_MSuu-4000_MChi-1500_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v3/80000/32F31612-9557-7D40-9B51-CDFB67D4280C.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("BESTInputs_WB_2016_output.root")
)
