...
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL18MiniAODv2/SuuToChiChiToHTHTToJets_MSuu-5000_MChi-1500_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v16_L1v1-v3/50000/AAD2FFDB-710E-3D4F-A166-014A30CEFAD2.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("BESTInputs_HT_2018_output.root")
)
