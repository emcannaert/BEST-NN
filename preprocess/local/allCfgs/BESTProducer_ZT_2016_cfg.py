...
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL16MiniAODv2/SuuToChiChiToZTZTToJets_MSuu-4000_MChi-1000_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v1/60000/8D07D15B-AB1D-E348-9014-0BFB49566112.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("BESTInputs_ZT_2016_output.root")
)
