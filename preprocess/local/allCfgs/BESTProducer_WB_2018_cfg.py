...
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL18MiniAODv2/SuuToChiChiToWBWBToJets_MSuu-7000_MChi-1000_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v16_L1v1-v1/2550000/0C2BCADD-4AE6-E845-8716-E45781824073.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("BESTInputs_WB_2018_output.root")
)
