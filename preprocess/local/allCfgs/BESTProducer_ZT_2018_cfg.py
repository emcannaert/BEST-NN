...
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL18MiniAODv2/SuuToChiChiToZTZTToJets_MSuu-5000_MChi-2000_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v16_L1v1-v2/2560000/BBDBABFC-E1F4-0A4A-8F31-F304DB605706.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("BESTInputs_ZT_2018_output.root")
)
