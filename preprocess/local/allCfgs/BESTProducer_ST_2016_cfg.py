...
process.run = cms.EDProducer("BESTProducer",
 jetType = cms.string("ST"),
 genPartCollection = cms.string("prunedGenParticles"),
 fatJetCollection = cms.InputTag("selectedUpdatedPatJetsAK8UpdatedJEC"),
 jetCollection = cms.InputTag("selectedUpdatedPatJetsPileupJetID"),
 year = cms.string("2016"), #types: 2015,2016,2017,2018
 bits = cms.InputTag("TriggerResults", "", "HLT"),
 triggers = cms.string("HLT_PFHT900_v"),
)
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring("/store/mc/RunIISummer20UL16MiniAODv2/ST_t-channel_top_4f_InclusiveDecays_mtop1755_TuneCP5_13TeV-powheg-madspin-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v3/120000/053E5FAA-5A87-CE45-B431-2E9C654302AC.root"
)
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("BESTInputs_ST_2016_output.root")
)
