...
config = config()
config.General.requestName = 'BESTInputTrees_2017_QCD_0_AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../../local/allCfgs//BESTProducer_QCD_2017_cfg.py'
config.Data.inputDataset = '/QCD_Pt-150to3000_TuneCP5_FlatPower7_13TeV_pythia8/RunIISummer19UL17MiniAODv2-106X_mc2017_realistic_v9-v1/MINIAODSIM'
